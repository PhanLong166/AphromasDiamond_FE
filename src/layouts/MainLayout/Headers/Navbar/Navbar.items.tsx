        ...
        children: [
          {
            ...
            label: (
              <Link
                to={`${config.routes.public.diamondRingList.replace(
                  ":ringType",
                  "round-ring"
                )}`}
              >
        ...
        children: [
          {
            ...
            label: (
              <Link
                to={`${config.routes.public.designerList.replace(
                  ":designer",
                  "vancleefnarpels"
                )}`}
              >
  ...
  },
  {
    ...
    children: [
        ...
        children: [
          {
            ...
            label: (
              <Link
                to={`${config.routes.public.engagementShape.replace(
                  ":ringShape",
      ...
      },
      {
        ...
        children: [
          {
            key: "engagement-ring-metal-1",
            label: (
              <Link
                to={`${config.routes.public.menEngagement.replace(
                  ":ringMetal",
                  "white-gold"
                )}`}
              >
      ...
      },
      {
        ...
        children: [
          {
            key: "engagement-ring-designer-1",
            label: (
              <Link
                to={`${config.routes.public.engagementDesigner.replace(
                  ":designer",
                  "zaczacposen"
                )}`}
              >
          ...
          {
            key: "engagement-ring-designer-2",
            label: (
              <Link
                to={`${config.routes.public.engagementDesigner.replace(
                  ":designer",
          ...
          {
            key: "engagement-ring-designer-3",
            label: (
              <Link
                to={`${config.routes.public.engagementDesigner.replace(
                  ":designer",
          ...
          {
            key: "engagement-ring-designer-4",
            label: (
              <Link
                to={`${config.routes.public.engagementDesigner.replace(
                  ":designer",
  ...
  },
  {
    ...
    children: [
        ...
        children: [
          {
            ...
            label: (
              <Link
                to={`${config.routes.public.weddingShape.replace(
                  ":ringShape",
                  "round-wedding-ring"
                )}`}
              >
      ...
      },
      {
        ...
        children: [
          {
            key: "wedding-ring-metal-1",
            label: (
              <Link
                to={`${config.routes.public.menWedding.replace(
                  ":ringMetal",
                  "white-gold"
                )}`}
              >
      ...
      },
      {
        ...
        children: [
          {
            key: "wedding-ring-designer-1",
            label: (
              <Link
                to={`${config.routes.public.weddingDesigner.replace(
                  ":designer",
                  "zaczacposen"
                )}`}
              >
        ...
        children: [
          {
            ...
            label: (
              <Link
                to={`${config.routes.public.jewelryList.replace(
                  ":jewelryType",
                  "ring"
                )}`}
              >
        ...
        children: [
          {
            ...
            label: (
              <Link
                to={`${config.routes.public.firmList.replace(
                  ":jewelryFirm",
                  "VanCleef&Arpels"
                )}`}
              >
