...
const data: OrderData[] = [
  { rowNumber: 1, product: 'Diamond Ring', orderDate: '2 Jan 2023', price: '1000$', status: 'Delivered' },
  { rowNumber: 2, product: 'Diamond Necklaces', orderDate: '14 Dec 2022', price: '2450$', status: 'Delivered' },
  { rowNumber: 3, product: 'Diamond Earrings', orderDate: '14 Dec 2022', price: '700$', status: 'Canceled' },
  ...
  { rowNumber: 6, product: 'Diamond Round', orderDate: '14 Dec 2022', price: '5000$', status: 'Delivered' },
];
...
const OrderList = () => {
  ...
  const menuItems4 = [
    { text: 'Delivered', link: '#option1' },
    { text: 'Canceled', link: '#option2' },
  ];
