...
const NecklaceDetails = () => {
  const [mainImage, setMainImage] = useState('https://firebasestorage.googleapis.com/v0/b/testsaveimage-abb59.appspot.com/o/Necklace%2Fneckdetails.png?alt=media&token=6b4d89e3-2479-4a90-9cd0-2f6f1e0e5f70');
      ...
      <Container>
        ...
        <Wrap>
          <ProductDotGrid>
            <Wrapper>
              <ImageContainer>
                <OuterThumb>
                  <ThumbnailImage>
                    {['https://firebasestorage.googleapis.com/v0/b/testsaveimage-abb59.appspot.com/o/Necklace%2Fneckdetails.png?alt=media&token=6b4d89e3-2479-4a90-9cd0-2f6f1e0e5f70', 'https://firebasestorage.googleapis.com/v0/b/testsaveimage-abb59.appspot.com/o/Necklace%2Fneckdetails2.png?alt=media&token=2d2f84e7-afe8-4e8c-a5a1-b3344a6c6b07', 'https://firebasestorage.googleapis.com/v0/b/testsaveimage-abb59.appspot.com/o/Necklace%2Fneckdetails1.png?alt=media&token=c670022b-d3a2-4f70-8792-ff1099b1b14e'].map((src, index) => (
                      <Item
                        key={index}
          ...
          <ProductDetail>
            <Entry>
              <Heading>
                <Title>Three-Stone Trapezoid Sidestone Diamond Necklace</Title>
                <ProductRating>
                  <StarFilled/>
                  <StarFilled/>
                  <StarFilled/>
              ...
              <ProductMetal>
                ...
                <div className="wrap">
                  <button className="metal-button white selected"><span>14k</span></button>
                  <button className="metal-button yellow"><span>14k</span></button>
                  <button className="metal-button rose"><span>14k</span></button>
                  <button className="metal-button platinum"><span>Pt</span></button>
                </div>
              </ProductMetal>
              <ProductInfo>
                <div className="wrap">
