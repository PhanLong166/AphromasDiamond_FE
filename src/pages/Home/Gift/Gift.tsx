...
const Gift = () => {
  ...
  const jewelryData: Record<string, any> = {
    "top-ten-bracelet": {
      ...
      products: products.filter((product) => product.categories === "bracelet" && product.gift === true),
      faqs: [
        {
          key: "1",
    ...
    "top-ten-necklace": {
      ...
      products: products.filter((product) => product.categories === "necklace" && product.gift === true),
      faqs: [
        {
          key: "1",
          label: "What is the average cost of a womens diamond wedding ring?",
    ...
    "top-ten-earrings": {
      ...
      products: products.filter((product) => product.categories === "earrings" && product.gift === true),
      faqs: [
        {
          key: "1",
          label: "What is the average cost of a womens diamond wedding ring?",
    ...
    "top-ten-ring": {
      ...
      products: products.filter((product) => product.type === "Ring" && product.gift === true),
      faqs: [
        {
          key: "1",
          label: "What is the average cost of a womens diamond wedding ring?",
